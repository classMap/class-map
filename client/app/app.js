...
App.controller('formController', function($scope, $http) {
  ...
  $scope.addMajor = function(){
    ...
    //creates title with user's major
    $('<div id = "majorHeader"></div>').append("Your major is: " + $scope.major).fadeIn(1000).appendTo('body');
    ...
    $('#trash').droppable({
          drop: function(event, ui) {
              ...
              $scope.units-=4;
              $("#units").remove();
              $('<div id = "units"></div>').append("Units earned: " +$scope.units).appendTo('body');
  ...
  $scope.units = 40;
  $("#units").remove();
  $('<div id = "units"></div>').append("Units earned: " +$scope.units).fadeIn(1000).appendTo('body');
